...
function CreateFile({ onUpdate }) {
    ...
    async function FileCreate() {
        ...
        try {
            ...
            let result = await axios.post(`http://localhost:4000/api/createFile_folder/${newUser.id}/${folderName}`, data, {
                headers: {
                    'x-auth-token': token
                }
            })
        ...
        document.getElementById('createFolderFile-close').click()
        onUpdate(fileName)
    }
    return (
        <>

            <div className="modal fade" id="createFolderFile" tabIndex="-1" aria-labelledby="creareFile" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="createFolderFile">Create File</h5>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" data-dismiss="modal" id="createFolderFile-close">Close</button>
